...
import { VERSION, CONFIG, ELEMENT_IDS, UI_CONFIG, OPERATION_STATE, FEATURE_FLAGS } from './config.js';
  ...
  const executeAutoReload = () => {
    ...
    overlay.innerHTML = `
      ...
      ">
        ...
        <div style="opacity: 0.8;">Reloading...</div>
      </div>
    `;
