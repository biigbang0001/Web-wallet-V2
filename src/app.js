  ...
  async initializeI18nRobust() {
    return new Promise((resolve) => {
      try {
        ...
        const selectorLng = selector ? selector.value : null;
        
        let targetLng = savedLng || selectorLng || 'en';
        
        if (!savedLng && selectorLng && selectorLng !== 'en') {
          targetLng = selectorLng;
          localStorage.setItem('nito_lang', targetLng);
        }
